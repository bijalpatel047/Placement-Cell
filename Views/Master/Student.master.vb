...
Partial Class Views_Master_Student
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        '    If Not (Session("ID") Like "MCA*") Or Not (Session("ID") Like "PGDCSA*") Or Not (Session("ID") Like "PGDNA*") Or Not (Session("ID") Like "MTECH_WEB*") Then
        '        Response.Redirect("/Placement1_SHRUTI//Views/Login/Login.aspx")
        '    End If
        'End If
    End Sub
