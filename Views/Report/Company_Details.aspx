<%@ Page Language="VB" MasterPageFile="~/Views/Master/HomePage.master" AutoEventWireup="false" CodeFile="Company_Details.aspx.vb" Inherits="Views_Faculty_Company_Details_F" title="Untitled Page" %>
        ...
        <ContentTemplate>
                ...
                <table style="width: 70%">
                    <tr>
                        <td style="width: 125px">
                            <asp:Label ID="lbl_company_name" runat="server" Text="Select Company" 
                        ...
                        <td>
                            <asp:DropDownList ID="ddl_course" runat="server" AutoPostBack="True" 
                                ...
                                DataValueField="Company_Name" Width="130px">
                            </asp:DropDownList>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="ddl_course" Name="Company_Name" 
            ...
            <asp:FormView ID="FormView1" runat="server" AllowPaging="True" DataSourceID="SqlDataSource1" 
                ...
                <ItemTemplate>
                    ...
                    <%--<span style="font-size: medium; font-weight: bold">&nbsp;Company Details</span> --%>
                     <fieldset> 
                     <legend > <h2> Company Information</h2> </legend>  
                     <table style="width: 140%; height: 410px">
                        <tr>
